...
def multimodal_query(query):
    results = nvingest_retrieval(
        ...
        milvus_uri = os.environ.get("MULTIMODAL_MILVUS_URL"),
        hybrid=False,
        embedding_endpoint=os.environ.get("MULTIMODAL_EMBEDDING_ENDPOINT"),
        model_name=os.environ.get("MULTIMODAL_EMBEDDING_MODEL_NAME"),
        top_k=1,
        gpu_search=True,
    )
    return results[0][0]
